...
*/
  ...
  //
  // Operation mode configuration (16bpp)  (操作模式配置)
  //
  ...
  //
  // Drawing mode configuration (18bpp)  (绘图模式设定)
  //
  ...
  //
  // Setting up hardware interface to be used (设置硬件接口)
  //
  ...
  //
  // Setting up interface for reading back data (设置接口，用于读回数据)
  //
  ...
  //
  // Display controller configuration  (显示控制器配置)
  //
  ...
  //
  // Setting up hardware interface to be used(设置硬件接口使用)
  //
