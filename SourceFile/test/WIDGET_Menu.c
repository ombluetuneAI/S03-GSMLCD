...
*
* Purpose:
*   Creates the menu widget (创建菜单控件)
*/
...
*
* Purpose:
*   Draws a vertical gradient（垂直梯度）
*/
...
void MainTask(void) {
  ...
  // Create frame window
  //
  _hFrame = FRAMEWIN_CreateEx(10, 10, 220, 176, WM_HBKWIN, WM_CF_SHOW, FRAMEWIN_CF_MOVEABLE, 0, "Application with menu", _cbClient);
