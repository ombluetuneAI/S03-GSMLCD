...
extern void ZoneWirelessClose(void);//关闭防区
...
{
	{0,0,1,0,0,{&App.Menu.RemoteForm,},//删除当前号码
	},
	{0,0,1,0,0,{&App.Menu.RemoteForm,},//删除所有号码
	},
	{0,0,1,0,0,{&App.Menu.RemoteForm,},
	},//返回上一级
};
...
{
	0,0,1,0,0,{&App.Menu.PhoneEditForm,},//号码列表的功能选择项列表
	null,
	null,
	null,
	PhoneTypeAddr,
...
{
	{0,0,1,0,0,{&App.Menu.AddPhoneForm,}},//添加号码
	{0,0,1,0,0,{&App.Menu.PhoneSetForm,},//设置号码
		null,
		null,
		null,
		PhoneTypeAddr,
	...
	{0,0,1,0,0,{&App.Menu.PhoneDelForm,},//删除号码
		null,
		null,
		null,
		null,
		DeleteCancel,//清除上次的操作记录
	},
};
extern void DeleteAllNumber(void);
static MenuListStruct DeleteNumber[3]=
{
	{0,0,1,0,0,{&App.Menu.PhoneListForm,},//删除当前号码
	},
	{0,0,1,0,0,{&App.Menu.PhoneListForm,},//删除所有号码
	},
...
{
	0,0,1,0,0,{&App.Menu.AutoSetupForm,},//删除号码
	null,
	null,
	null,
	AutoAddrGet,
...
static void MenuSetup(void)
{
	...
	for(i=0;i<SetupTabSize;i++)
	{
		...
		SetupMenu.SubMenus[i]=&SetupFuncTab[i];//下一个节点
	}
...
static void MenuPhone(void)
{
	...
	for(i=0;i<9;i++)
  {
	...
	PhoneSetupAdd.SubMenus[0]=&NumberEdit[0];//添加号码
	PhoneSetupAdd.SubMenus[1]=&NumberEdit[1];//设置
	PhoneSetupAdd.SubMenus[2]=&NumberEdit[2];//删除选择项
...
void MenuListInit(void)
{
  MainMenu.SubMenus = malloc(sizeof(&MainMenu)*1);
	...
	MainMenu.SubMenus[0]=&IconMenu;//下一个节点
	MainMenu.Parent=NULL;//到顶了
